...
function VAIcon(props) {
  return (
    <svg
      classsName="va-icon-svg"
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
      viewBox="0 0 600.01 343.7"
      width="65"
      {...props}
    >
      <defs>
        ...
        <clipPath id="clip-path" transform="translate(-199.99 -328.15)">
          <rect className="cls-1" x="200.06" y="328.15" width="599.77" height="343.7" />
        </clipPath>
      </defs>
      <title>VA</title>
      <g className="cls-2">
